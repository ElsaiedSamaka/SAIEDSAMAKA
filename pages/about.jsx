        ...
        <div className='container'>
          <div className='text-wrapper w-full'>
            ...
            <p>
              ...
              and that thing i intend to change <strong>my time is NOW!</strong>
              <br />
            ...
            <ul className='contact-links'>
              ...
              <li>
                Other relevant course work — various online education programmes
                2014 - present Intermediate Next.js (2020), GraphQL Essentials
                (2020), node advanced concepts (2019), Advanced React (2018),
                Advanced JavaScript (2018) Intermediate .Net (2015), Front End
